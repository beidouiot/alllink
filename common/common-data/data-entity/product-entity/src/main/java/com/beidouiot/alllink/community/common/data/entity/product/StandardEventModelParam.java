...
@Entity
@Table(name = EntityConstants.STANDARD_EVENT_MODEL_PARAM)
@DynamicInsert(value = true)
@DynamicUpdate(value = true)
@ToString(callSuper=true)
public class StandardEventModelParam extends BaseEntity {
	...
	@Column(name = EntityConstants.STANDARD_EVENT_MODEL_ID, nullable = false, columnDefinition = EntityConstants.STANDARD_EVENT_MODEL_ID_COLUMN_DEFINITION)
	private Long standardEventModelId;
}
