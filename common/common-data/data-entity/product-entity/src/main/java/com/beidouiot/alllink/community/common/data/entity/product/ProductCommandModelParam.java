...
public class ProductCommandModelParam extends BaseEntity {
	...
	@Column(name = EntityConstants.PRODUCT_COMMAND_MODEL_ID, nullable = false, columnDefinition = EntityConstants.PRODUCT_COMMAND_MODEL_ID_COLUMN_DEFINITION)
