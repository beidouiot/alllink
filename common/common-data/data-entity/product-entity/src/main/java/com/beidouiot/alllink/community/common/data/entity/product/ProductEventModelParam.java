...
@Entity
@Table(name = EntityConstants.PRODUCT_EVENT_MODEL_PARAM)
@DynamicInsert(value = true)
@DynamicUpdate(value = true)
@ToString(callSuper=true)
public class ProductEventModelParam extends BaseEntity {
	...
	@Column(name = EntityConstants.PRODUCT_EVENT_MODEL_ID, nullable = false, columnDefinition = EntityConstants.PRODUCT_EVENT_MODEL_ID_COLUMN_DEFINITION)
