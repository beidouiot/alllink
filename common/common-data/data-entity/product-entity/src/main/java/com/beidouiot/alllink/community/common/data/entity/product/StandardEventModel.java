...
@Entity
@Table(name = EntityConstants.STANDARD_EVENT_MODEL)
@DynamicInsert(value = true)
@DynamicUpdate(value = true)
@ToString(callSuper=true)
public class StandardEventModel extends BaseEntity {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2119754586834959183L;

	@Column(name = EntityConstants.NAME, nullable = false, columnDefinition = EntityConstants.STANDARD_EVENT_MODEL_NAME_COLUMN_DEFINITION)
	private String name;
	
	@Column(name = EntityConstants.CODE, nullable = false, columnDefinition = EntityConstants.STANDARD_EVENT_MODEL_CODE_COLUMN_DEFINITION)
	private String code;
	
	@Column(name = EntityConstants.STANDARD_EVENT_MODEL_EVENT_TYPE, nullable = false, columnDefinition = EntityConstants.STANDARD_EVENT_MODEL_EVENT_TYPE_COLUMN_DEFINITION)
