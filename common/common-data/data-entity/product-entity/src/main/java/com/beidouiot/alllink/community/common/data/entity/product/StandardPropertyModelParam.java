...
@Entity
@Table(name = EntityConstants.STANDARD_PROPERTY_MODEL_PARAM)
@DynamicInsert(value = true)
@DynamicUpdate(value = true)
@ToString(callSuper=true)
public class StandardPropertyModelParam extends BaseEntity {
	...
	@Column(name = EntityConstants.STANDARD_PROPERTY_MODEL_ID, nullable = false, columnDefinition = EntityConstants.STANDARD_PROPERTY_MODEL_ID_COLUMN_DEFINITION)
