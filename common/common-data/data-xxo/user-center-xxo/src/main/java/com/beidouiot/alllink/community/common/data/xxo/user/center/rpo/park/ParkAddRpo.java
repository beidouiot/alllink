 ...
 * 
 *
 * @Description 增加园区/小区请求信息
 * @author longww
 * @date 2021年4月11日
 */
@Api(tags="增加园区/小区请求信息")
@Data
@NoArgsConstructor
@AllArgsConstructor
@ToString
public class ParkAddRpo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4374325738374763998L;
	...
	@ApiModelProperty(value = "园区/小区描述, length = 200", dataType = "String", required = false)
	@Length(min=0, max=200, message="园区/小区描述长度不能超过200个字符")
