...
@AllArgsConstructor
@ToString
public class IndustryUpdateRpo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4364153116164362997L;
	
	@ApiModelProperty(value = "行业Id", dataType = "Long", required = true)
	@NotNull(message = "行业Id不能为空！")
	@CheckNumber(message = "行业Id必须为正整数" )
	private Long id;
