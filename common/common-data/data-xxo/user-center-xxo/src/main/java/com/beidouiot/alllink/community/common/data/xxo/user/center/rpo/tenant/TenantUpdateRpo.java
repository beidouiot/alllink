...
@AllArgsConstructor
@ToString
public class TenantUpdateRpo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7338390264084724844L;
	
	@ApiModelProperty(value = "租户Id", dataType = "Long", required = true)
	@NotNull(message = "租户Id不能为空！")
	@CheckNumber(message = "租户Id必须为正整数" )
	private Long id;
	...
	@ApiModelProperty(value = "所属行业, length = 6", dataType = "Long", required = false)
