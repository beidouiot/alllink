...
public class UserAddRpo implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5967773614920562155L;

	@ApiModelProperty(value = "用户账号, length = 3~20", dataType = "String", required = true)
	@NotBlank(message = "用户名不能为空！")
	@Length(min=3, max=20, message="用户名长度不能小于3个字符且不能超过20个字符")
	private String username;
	
	@ApiModelProperty(value = "用户密码, length = 6位以上", dataType = "String", required = true)
