...
@AllArgsConstructor
@ToString
public class MenuUpdateRpo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -673866859970772385L;
	
	@ApiModelProperty(value = "菜单Id", dataType = "Long", required = true)
	@NotNull(message = "菜单Id不能为空！")
	@CheckNumber(message = "菜单Id必须为正整数" )
	private Long id;
