...
* @date 2022年2月11日
*/
@Api(tags="增加标准指令物模型参数请求信息")
@Data
@NoArgsConstructor
@AllArgsConstructor
@ToString
public class StandardCommandModelParamAddRpo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2955883998950024209L;
	...
	@ApiModelProperty(value = "标准指令物模型id", dataType = "Long", required = true)
	@NotNull(message = "标准指令物模型id不能为空！")
	@CheckNumber(message = "标准指令物模型id必须为正整数" )
