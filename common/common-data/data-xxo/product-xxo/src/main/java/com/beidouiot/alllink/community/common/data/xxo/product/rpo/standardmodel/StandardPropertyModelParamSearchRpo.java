...
* @date 2022年2月11日
*/
@Api(tags="查询标准属性物模型参数请求信息")
@Data
@EqualsAndHashCode(callSuper=false)
@NoArgsConstructor
@AllArgsConstructor
@ToString
public class StandardPropertyModelParamSearchRpo extends SearchBaseRpo {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6966356716453401377L;
	...
	@ApiModelProperty(value = "标准属性物模型id", dataType = "Long", required = false)
