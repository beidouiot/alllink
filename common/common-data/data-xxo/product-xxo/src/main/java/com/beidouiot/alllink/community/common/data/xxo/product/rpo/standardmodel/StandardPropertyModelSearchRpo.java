...
* @date 2022年2月11日
*/
@Api(tags="查询标准属性物模型请求信息")
@Data
@EqualsAndHashCode(callSuper=false)
@NoArgsConstructor
@AllArgsConstructor
@ToString
public class StandardPropertyModelSearchRpo extends SearchBaseRpo {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 8380798144662587021L;
