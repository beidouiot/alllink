...
* @date 2022年2月11日
*/
@Api(tags="增加产品事件物模型参数请求信息")
@Data
@NoArgsConstructor
@AllArgsConstructor
@ToString
public class ProductEventModelParamAddRpo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -833994516394638392L;
