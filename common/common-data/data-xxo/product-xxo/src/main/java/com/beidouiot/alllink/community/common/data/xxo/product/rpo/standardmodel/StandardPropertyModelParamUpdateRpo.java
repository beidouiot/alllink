...
* @date 2022年2月11日
*/
@Api(tags="修改标准属性物模型参数请求信息")
@Data
@NoArgsConstructor
@AllArgsConstructor
@ToString
public class StandardPropertyModelParamUpdateRpo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3601306014583208105L;

	@ApiModelProperty(value = "标准属性物模型参数Id", dataType = "Long", required = true)
	@NotNull(message = "标准属性物模型参数Id不能为空！")
	@CheckNumber(message = "标准属性物模型参数Id必须为正整数" )
	private Long id;
