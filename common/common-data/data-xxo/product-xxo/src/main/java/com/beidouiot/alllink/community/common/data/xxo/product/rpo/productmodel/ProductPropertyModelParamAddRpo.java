...
* @date 2022年2月11日
*/
@Api(tags="增加产品属性物模型参数请求信息")
@Data
@NoArgsConstructor
@AllArgsConstructor
@ToString
public class ProductPropertyModelParamAddRpo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 528025525238713891L;
