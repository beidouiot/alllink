...
/**
*
* @Description 修改标准物模型请求信息
* @author longww
* @date 2021年12月23日
*/
@Api(tags="修改标准物模型请求信息")
@Data
@NoArgsConstructor
@AllArgsConstructor
@ToString
public class StandardModelUpdateRpo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8961983738233489078L;
	
	@ApiModelProperty(value = "标准物模型Id", dataType = "Long", required = true)
	@NotNull(message = "标准物模型Id不能为空！")
	@CheckNumber(message = "标准物模型Id必须为正整数" )
	private Long id;
