...
* @date 2022年2月11日
*/
@Api(tags="增加标准事件物模型参数请求信息")
@Data
@NoArgsConstructor
@AllArgsConstructor
@ToString
public class StandardEventModelParamAddRpo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3551246646506055174L;
