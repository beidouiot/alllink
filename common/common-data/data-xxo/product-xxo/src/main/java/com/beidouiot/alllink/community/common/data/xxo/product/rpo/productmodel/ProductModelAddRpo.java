...
/**
*
* @Description 增加产品物模型请求信息
* @author longww
* @date 2021年12月23日
*/
@Api(tags="增加产品物模型请求信息")
@Data
@NoArgsConstructor
@AllArgsConstructor
@ToString
public class ProductModelAddRpo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 112686895764621166L;
