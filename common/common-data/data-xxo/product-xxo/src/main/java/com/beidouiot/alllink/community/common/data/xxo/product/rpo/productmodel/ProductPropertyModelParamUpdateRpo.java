...
* @date 2022年2月11日
*/
@Api(tags="修改产品属性物模型参数请求信息")
@Data
@NoArgsConstructor
@AllArgsConstructor
@ToString
public class ProductPropertyModelParamUpdateRpo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -297754587880238209L;

	@ApiModelProperty(value = "产品属性物模型参数Id", dataType = "Long", required = true)
	@NotNull(message = "产品属性物模型参数Id不能为空！")
	@CheckNumber(message = "产品属性物模型参数Id必须为正整数" )
	private Long id;
