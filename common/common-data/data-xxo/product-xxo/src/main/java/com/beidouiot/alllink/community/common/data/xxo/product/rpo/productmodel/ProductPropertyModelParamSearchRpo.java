...
* @date 2022年2月11日
*/
@Api(tags="查询产品属性物模型参数请求信息")
@Data
@EqualsAndHashCode(callSuper=false)
@NoArgsConstructor
@AllArgsConstructor
@ToString
public class ProductPropertyModelParamSearchRpo extends SearchBaseRpo {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1796013931434241103L;
	...
	@ApiModelProperty(value = "产品属性物模型id", dataType = "Long", required = false)
