...
* @date 2022年2月11日
*/
@Api(tags="修改产品指令物模型参数请求信息")
@Data
@NoArgsConstructor
@AllArgsConstructor
@ToString
public class ProductCommandModelParamUpdateRpo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 41235959917754294L;
