...
* @date 2022年2月11日
*/
@Api(tags="查询标准事件物模型参数请求信息")
@Data
@EqualsAndHashCode(callSuper=false)
@NoArgsConstructor
@AllArgsConstructor
@ToString
public class StandardEventModelParamSearchRpo extends SearchBaseRpo {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -286457884704457685L;
	...
	@ApiModelProperty(value = "标准事件物模型id", dataType = "Long", required = false)
