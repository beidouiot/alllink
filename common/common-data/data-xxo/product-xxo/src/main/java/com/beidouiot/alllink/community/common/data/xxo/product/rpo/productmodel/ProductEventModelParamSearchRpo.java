...
* @date 2022年2月11日
*/
@Api(tags="查询产品事件物模型参数请求信息")
@Data
@EqualsAndHashCode(callSuper=false)
@NoArgsConstructor
@AllArgsConstructor
@ToString
public class ProductEventModelParamSearchRpo extends SearchBaseRpo {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 2390891553552765466L;
	...
	@ApiModelProperty(value = "产品事件物模型id", dataType = "Long", required = false)
