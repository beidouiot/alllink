...
@RegularMqttSubscription(topic = "+/+/commands/up")
public class CommandsRegularConsumer implements RegularMqttListener {
    ...
    public void consume(String topic, MqttMessage mqttMessage) {
    	...
    	deviceDataFeignClient.receivedCommands(jsonObj);
    }
}
